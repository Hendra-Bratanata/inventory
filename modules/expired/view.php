<section class="content-header">
  <h1>
    <i class="fa fa-sign-in icon-title"></i> Data Barang Preoritas
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              while ($data = mysqli_fetch_assoc($query)) {
                ...
                // $hariIni        = strtotime('6-8-2023');
                // $expProduk      = strtotime('10-8-2023');
                ...
                echo "<tr>
                      ...
                      if($selisihHari < 30 && $selisihHari > 15){
                        echo "<td width='100' class='center bg-warning'>$selisihHari</td>";
                      }
                      else if($selisihHari < 15){
                        echo "<td width='100' class='center bg-danger'>$selisihHari</td>";
                      }
                     else{
                      echo "<td width='100' class='center bg-success'>$selisihHari</td>";
                     }


                      echo "<td width='120' align='right' class='center'>$data[jumlah_masuk]</td>
